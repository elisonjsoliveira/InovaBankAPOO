...
CREATE TABLE `account` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `UK_27afjp0b8sbbdpqrgjubhpewl` (`accountNumber`),
  KEY `FKs6uwswu9l19svmc00r9pfvaeb` (`client_id`),
  CONSTRAINT `FKs6uwswu9l19svmc00r9pfvaeb` FOREIGN KEY (`client_id`) REFERENCES `clients` (`id`)
