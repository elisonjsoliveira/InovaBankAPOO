...
CREATE TABLE `savingsaccount` (
  `interestRate` decimal(38,2) DEFAULT NULL,
  `latest_interest_update` date DEFAULT NULL,
  `id` bigint NOT NULL,
  PRIMARY KEY (`id`),
  CONSTRAINT `FKia5jjv98s1rnhgsgm4b6ycxg` FOREIGN KEY (`id`) REFERENCES `account` (`id`)
